...
export default function HeroSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success("Du bist auf der Liste! Wir melden uns bald.");
    setEmail("");
    setPhone("");
    setName("");
    setLoading(false);
      ...
      <div className="max-w-7xl mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-lg mx-auto lg:mx-0 mb-10 leading-relaxed">
            Relengo verbindet dich mit Menschen in deiner Nähe, um
            Outdoor-Ausrüstung, Kameras, Werkzeuge und mehr zu verleihen und zu
            mieten.
            <span className="text-[#1A1A1A] font-medium">
              {" "}
              Wert bleibt in Bewegung.
            </span>
          </p>
          ...
          >
            ...
            >
              {loading ? "Wird eingetragen..." : "Warteliste beitreten"}
              <ArrowRight className="w-5 h-5" />
            </button>
          </form>

          <p className="text-sm text-gray-500 mb-6">
            Schließe dich <span className="text-[#F68B28] font-semibold">1000+</span>{" "}
            anderen
            an, die auf frühen Zugang warten
          </p>
